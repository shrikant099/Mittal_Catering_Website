    ...
    <footer className="bg-black text-gray-300">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">
              Mittal Bhawan, Near All Saints School,
              <br />
            ...
            <p className="text-sm mb-3">
              📞
              <a href="tel:+919983748159" className="hover:text-primary">
                +91 99837 48159
              </a>
            </p>

            <p className="text-sm flex mb-4">
              <a
                href="mailto:mittalcatering.ajmer@gmail.com"
                className="hover:text-primary text-[12px] truncate"
              >
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="rounded hover:bg-primary hover:text-black transition"
                aria-label="Facebook"
              >
                <Facebook size={18} />
              </a>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-sm text-gray-500">
          ...
          <span className="text-primary font-medium">Mittal Catering</span>. All
          Rights Reserved.
        </div>
      </div>
    </footer>
