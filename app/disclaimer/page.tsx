    ...
    <section className="bg-black text-gray-300">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          <p>
            The words with initial capital letters used in this Disclaimer shall
            have the meanings defined below. These definitions shall apply
            regardless of whether the words appear in singular or plural form.
          </p>

          <p>
            For the purposes of this Disclaimer, “Company”, “We”, “Us”, or “Our”
            refers to Mittal Catering Ajmer, having its principal place of
            business at House No. 1053A, Mittal Bhawan, Dhola Bhata Road, near
          ...
          <p>
            ...
            and promotional purposes only. While we endeavour to keep the
            content accurate, complete, and up to date, Mittal Catering Ajmer
            makes no representations or warranties of any kind, express or
            implied, regarding the accuracy, reliability, suitability, or
            availability of the information, services, menus, images, or related
          ...
          <p>
            ...
            inaccuracies in the content of the Website. In no event shall Mittal
            Catering Ajmer be liable for any direct, indirect, incidental,
            special, consequential, or punitive damages arising out of or in
            connection with your access to, use of, or inability to use the
            Website or any content therein, whether based on contract,
          ...
          <p>
            ...
            links are provided for convenience only. Mittal Catering Ajmer does
            not endorse, guarantee, or assume responsibility for the accuracy,
            relevance, timeliness, or completeness of information available on
            such external websites, nor shall it be liable for any loss or
            damage arising from your use of them.
          </p>
          ...
          <p>
            The content available on the Website is intended solely for general
            guidance regarding our catering services and offerings. It should
            not be considered as professional advice of any kind, including but
            not limited to legal, financial, tax, health, or business advice.
            You are advised to consult appropriate professionals before making
            any decisions based on the information available on this Website.
          </p>
          ...
          <p>
            ...
            policies of Mittal Catering Ajmer. Users are solely responsible for
            the content they submit and any consequences arising from it. The
            Company reserves the right to remove or modify any content at its
            sole discretion.
          </p>
          ...
          <p>
            ...
            shall not be liable for any decisions made or actions taken based on
          ...
          <p>
            If you have any questions or concerns regarding this Disclaimer, you
            may &nbsp; <Link className="underline text-accent" href="/contact-us">contact us.</Link>
          </p>
        </div>
      </div>
    </section>
